...
function c1() {
  ...
  function o(u, d, s) {
    ...
    for (c in d) n.call(d, c) && !r.hasOwnProperty(c) && (w[c] = d[c]);
    if (u && u.defaultProps) for (c in d = u.defaultProps, d) w[c] === void 0 && (w[c] = d[c]);
    return { $$typeof: e, type: u, key: L, ref: j, props: w, _owner: i.current };
  }
...
function s1() {
  return qa || (qa = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function C(t) {
      {
        for (var M = arguments.length, b = new Array(M > 1 ? M - 1 : 0), m = 1; m < M; m++)
          b[m - 1] = arguments[m];
        K("error", t, b);
      }
    }
    function K(t, M, b) {
      {
        var m = Y.ReactDebugCurrentFrame, z = m.getStackAddendum();
        z !== "" && (M += "%s", b = b.concat([z]));
        var P = b.map(function(S) {
          return String(S);
        });
        P.unshift("Warning: " + M), Function.prototype.apply.call(console[t], console, P);
      }
    }
    var ff = !1, ef = !1, af = !1, Rf = !1, Zf = !1, bf;
    bf = Symbol.for("react.module.reference");
    function Hf(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === n || t === r || Zf || t === i || t === s || t === c || Rf || t === j || ff || ef || af || typeof t == "object" && t !== null && (t.$$typeof === L || t.$$typeof === w || t.$$typeof === o || t.$$typeof === u || t.$$typeof === d || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      t.$$typeof === bf || t.getModuleId !== void 0));
    }
    function aa(t, M, b) {
      var m = t.displayName;
      if (m)
    ...
    var jf = Object.assign, U = 0, Ne, Wf, ke, te, Se, De, Te;
    function E() {
    }
    ...
    function N() {
      {
        if (U === 0) {
          Ne = console.log, Wf = console.info, ke = console.warn, te = console.error, Se = console.group, De = console.groupCollapsed, Te = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: E,
    ...
    var x = Y.ReactCurrentDispatcher, k;
    function F(t, M, b) {
      {
        if (k === void 0)
          try {
...
` + p[Z].replace(" at new ", " at ");
                    return t.displayName && lf.includes("<anonymous>") && (lf = lf.replace("<anonymous>", t.displayName)), typeof t == "function" && X.set(t, lf), lf;
                  }
                while (Z >= 1 && H >= 0);
              break;
            }
        ...
        of = !1, x.current = P, D(), Error.prepareStackTrace = z;
      }
      var Vf = t ? t.displayName || t.name : "", Xa = Vf ? F(Vf) : "";
      return typeof t == "function" && X.set(t, Xa), Xa;
    }
    function hf(t, M, b) {
      return A(t, !1);
    }
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case w:
            return _(t.type, M, b);
          case L: {
            var m = t, z = m._payload, P = m._init;
            try {
              return _(P(z), M, b);
            } catch {
            }
    ...
    function Ff(t, M, b, m, z) {
      {
        var P = Function.call.bind(uf);
        for (var S in t)
          if (P(t, S)) {
            var p = void 0;
            try {
              if (typeof t[S] != "function") {
                var rf = Error((m || "React class") + ": " + b + " type `" + S + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof t[S] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw rf.name = "Invariant Violation", rf;
              }
              p = t[S](M, S, m, b, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (Z) {
              p = Z;
            }
    ...
    function B0(t) {
      {
        var M = typeof Symbol == "function" && Symbol.toStringTag, b = M && t[Symbol.toStringTag] || t.constructor.name || "Object";
        return b;
      }
    }
    function G0(t) {
    ...
    function Ua(t) {
      if (G0(t))
        return C("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", B0(t)), Oa(t);
    }
    var Ba = Y.ReactCurrentOwner, Z0 = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function F0(t, M) {
      typeof t.ref == "string" && Ba.current;
    }
    function _0(t, M) {
      {
        var b = function() {
          Ga || (Ga = !0, C("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", M));
        };
    ...
    function V0(t, M) {
      {
        var b = function() {
          Za || (Za = !0, C("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", M));
        };
    ...
    function X0(t, M, b, m, z) {
      {
        var P, S = {}, p = null, rf = null;
        b !== void 0 && (Ua(b), p = "" + b), W0(M) && (Ua(M.key), p = "" + M.key), H0(M) && (rf = M.ref, F0(M, z));
        for (P in M)
          uf.call(M, P) && !Z0.hasOwnProperty(P) && (S[P] = M[P]);
        if (t && t.defaultProps) {
        ...
        return K0(t, p, rf, z, m, Ba.current, S);
      }
    }
    var na = Y.ReactCurrentOwner, Ha = Y.ReactDebugCurrentFrame;
    function _f(t) {
      if (t) {
        var M = t._owner, b = _(t.type, t._source, M ? M.type : null);
        Ha.setExtraStackFrame(b);
      } else
...
Check the top-level render call using <` + b + ">.");
    ...
    function Va(t, M) {
      {
        ...
        if (Qf(t))
          ...
          if (typeof z == "function" && z !== t.entries)
            for (var P = z.call(t), S; !(S = P.next()).done; )
              ra(S.value) && _a(S.value, M);
        }
      }
    }
    function f1(t) {
    ...
    function e1(t) {
      {
        for (var M = Object.keys(t.props), b = 0; b < M.length; b++) {
          var m = M[b];
          if (m !== "children" && m !== "key") {
            _f(t), C("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", m), _f(null);
            break;
          }
        }
        t.ref !== null && (_f(t), C("Invalid attribute `ref` supplied to `React.Fragment`."), _f(null));
      }
    }
    function Ka(t, M, b, m, z, P) {
      {
        var S = Hf(t);
        if (!S) {
          var p = "";
        ...
        if (S) {
          ...
          if (lf !== void 0)
            if (m)
              if (Qf(lf)) {
                for (var Vf = 0; Vf < lf.length; Vf++)
                  Va(lf[Vf], t);
                Object.freeze && Object.freeze(lf);
              } else
                C("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");
            else
              Va(lf, t);
        }
        return t === n ? e1(H) : f1(H), H;
      }
    }
    function a1(t, M, b) {
      return Ka(t, M, b, !0);
    ...
    var i1 = n1, r1 = a1;
    de.Fragment = n, de.jsx = i1, de.jsxs = r1;
  })()), de;
}
var fn;
function l1() {
  return fn || (fn = 1, process.env.NODE_ENV === "production" ? xe.exports = c1() : xe.exports = s1()), xe.exports;
}
var l = l1();
const ta = {}, Pe = (f) => f ? f.replace(/\/$/, "") : typeof window < "u" && window.CHAT_API_BASE ? window.CHAT_API_BASE.replace(/\/$/, "") : typeof import.meta < "u" && (ta != null && ta.VITE_CHAT_API_BASE) ? (void 0).replace(/\/$/, "") : "https://borrador-n453.onrender.com/api", g1 = async (f, e, a, n) => {
  const i = Pe(n);
  try {
    const r = await fetch(`${i}/chat/start`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ clientId: f, systemCode: e, clientName: a ?? "" })
    });
    if (!r.ok) {
      const u = await r.text();
      return { status: r.status, error: u || `HTTP ${r.status}` };
    }
    const o = await r.json();
    return { status: 200, id: String(o.id) };
  } catch (r) {
...
function w1() {
  var n, i;
  const f = typeof window < "u" && window.CHAT_SIGNALR_BASE || ((i = (n = import.meta) == null ? void 0 : n.env) == null ? void 0 : i.VITE_CHAT_SIGNALR_BASE), e = M1();
...
const b1 = async (f, e, a = null) => {
  ...
  "button",
  {
    className: `chat-fab ${a > 0 ? "has-notification" : ""} ${r ? "pulse" : ""} ${n ? "loading" : ""}`,
    onClick: f,
    "aria-label": "Abrir chat en vivo",
    title: "Chat en Vivo",
    disabled: n,
    children: [
      i && /* @__PURE__ */ l.jsx("span", { className: "chat-fab-tooltip" }),
      a > 0 && /* @__PURE__ */ l.jsx("span", { className: "unread-badge", children: a > 99 ? "99+" : a }),
      /* @__PURE__ */ l.jsx("div", { className: "chat-fab-icon", children: /* @__PURE__ */ l.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ l.jsx("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }),
            /* @__PURE__ */ l.jsx("circle", { cx: "9", cy: "10", r: "0.5", fill: "currentColor", children: /* @__PURE__ */ l.jsx("animate", { attributeName: "opacity", values: "0.5;1;0.5", dur: "1.5s", repeatCount: "indefinite", begin: "0s" }) }),
            /* @__PURE__ */ l.jsx("circle", { cx: "12", cy: "10", r: "0.5", fill: "currentColor", children: /* @__PURE__ */ l.jsx("animate", { attributeName: "opacity", values: "0.5;1;0.5", dur: "1.5s", repeatCount: "indefinite", begin: "0.3s" }) }),
            /* @__PURE__ */ l.jsx("circle", { cx: "15", cy: "10", r: "0.5", fill: "currentColor", children: /* @__PURE__ */ l.jsx("animate", { attributeName: "opacity", values: "0.5;1;0.5", dur: "1.5s", repeatCount: "indefinite", begin: "0.6s" }) })
          ]
        }
      ) })
    ]
  ...
  onClose: f,
  title: e = "Soporte Técnico",
  status: a = "En línea"
}) => /* @__PURE__ */ l.jsxs("div", { className: "chat-header", children: [
  /* @__PURE__ */ l.jsxs("div", { className: "chat-header-info", children: [
    /* @__PURE__ */ l.jsx("span", { className: "chat-title", children: e }),
    /* @__PURE__ */ l.jsxs("span", { className: "chat-status", children: [
      /* @__PURE__ */ l.jsx("span", { className: "status-indicator" }),
      a
    ] })
  ] }),
  /* @__PURE__ */ l.jsx(
  ...
  var r;
  const n = f.sender === "client", i = f.sender === "system";
  return console.log("🟡 MessageBubble renderizando:", {
    sender: f.sender,
    content: f.content,
    attachments: f.attachments,
    attachmentsLength: ((r = f.attachments) == null ? void 0 : r.length) || 0
  }), /* @__PURE__ */ l.jsxs("div", { className: `message-bubble ${n ? "client" : i ? "system" : "agent"}`, children: [
    /* @__PURE__ */ l.jsxs("div", { className: "message-content", children: [
      f.content && /* @__PURE__ */ l.jsx("p", { children: f.content }),
      f.attachments && f.attachments.length > 0 && /* @__PURE__ */ l.jsx("div", { className: "message-attachments", children: f.attachments.map((o, u) => (console.log("🖼️ Procesando attachment en MessageBubble:", {
        fileName: o.fileName,
        fileType: o.fileType,
        filePath: o.filePath,
        isImage: o.fileType && o.fileType.startsWith("image/")
      }), /* @__PURE__ */ l.jsx("div", { className: "attachment", children: o.fileType && o.fileType.startsWith("image/") ? /* @__PURE__ */ l.jsx(
        "img",
        {
          src: o.filePath,
          alt: o.fileName,
          className: "attachment-image",
          onClick: () => e(o.filePath),
          onLoad: () => console.log("✅ Imagen cargada:", o.filePath),
          onError: () => console.log("❌ Error cargando imagen:", o.filePath)
        }
      ) : /* @__PURE__ */ l.jsxs("div", { className: "attachment-file", children: [
        /* @__PURE__ */ l.jsx("span", { className: "file-icon", children: "📄" }),
        /* @__PURE__ */ l.jsx("span", { className: "file-name", children: o.fileName })
      ] }) }, u))) })
    ] }),
    /* @__PURE__ */ l.jsx("div", { className: "message-time", children: a(f.sentAt) })
  ] });
}, h1 = ({
  messages: f,
  onImageClick: e,
  ...
  return B(() => {
    var i;
    (i = n.current) == null || i.scrollIntoView({ behavior: "smooth" });
  }, [f]), /* @__PURE__ */ l.jsxs("div", { className: "chat-messages", "aria-live": "polite", "aria-relevant": "additions text", children: [
    f.length === 0 && /* @__PURE__ */ l.jsxs("div", { className: "empty-chat", children: [
      /* @__PURE__ */ l.jsx(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
      ...
      /* @__PURE__ */ l.jsx("p", { children: "Envía tu primer mensaje" })
    ] }),
    f.map((i, r) => /* @__PURE__ */ l.jsx(
      y1,
      {
        message: i,
        onImageClick: e,
    ...
    /* @__PURE__ */ l.jsx("div", { ref: n })
  ] });
}, p1 = ({
  selectedFile: f,
  previewUrl: e,
  onCancel: a
}) => f ? /* @__PURE__ */ l.jsxs("div", { className: "file-preview", children: [
  e ? /* @__PURE__ */ l.jsx("img", { src: e, alt: "Previsualización" }) : /* @__PURE__ */ l.jsxs("div", { className: "file-info", children: [
    /* @__PURE__ */ l.jsxs(
      "svg",
      {
        xmlns: "http://www.w3.org/2000/svg",
        ...
        strokeLinejoin: "round",
        children: [
          /* @__PURE__ */ l.jsx("path", { d: "M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" }),
          /* @__PURE__ */ l.jsx("polyline", { points: "13 2 13 9 20 9" })
        ]
      }
    ),
...
function In(f) {
  return Ze(f) && (f === "*" || f.length > 1 && ":>~.+*".includes(f.slice(0, 1)) || Dn(f));
}
function Nn(f, e) {
  return (Ze(e) || typeof e == "number") && !Sn(f) && !Ca(f) && !kn(f);
}
function kn(f) {
...
var xn = class zn {
  constructor(e, a, n, i) {
    ...
    this.hash = this.selector.hasConditions ? this.selector.scopeClassName : Tn(this.sheet.name, this.joined), this.key = Je([this.joined, r, this.hash]);
  }
  toString() {
    let e = ga(this.selector.preconditions, {
      right: this.hash
    });
    return e = ga(this.selector.postconditions, {
      left: e
    }), `${e} {${zn.genRule(this.property, this.value)}}`;
  }
  static genRule(e, a) {
    const n = N1(e);
    return en(
...
function ga(f, { left: e = "", right: a = "" } = {}) {
  const n = f.reduce((i, r) => Ca(r) ? i + r : Dn(r) ? i + r.slice(1) : Je([i, r], " "), e);
  return Je([n, k1(a)], " ");
}
var D1 = class Re {
  constructor(e, a = null, {
    ...
    this.sheet = e, this.preconditions = [], this.scopeClassName = null, this.scopeName = null, this.postconditions = [], this.preconditions = n ? la(n) : [], this.postconditions = i ? la(i) : [], this.setScope(a);
  }
  setScope(e) {
    return e ? (this.scopeClassName || (this.scopeName = e, this.scopeClassName = Tn(
      this.sheet.name,
  ...
  addScope(e) {
    return new Re(this.sheet, e, {
      preconditions: this.preconditions,
      postconditions: this.postconditions
    });
  }
  addPrecondition(e) {
    return new Re(this.sheet, this.scopeClassName, {
      postconditions: this.postconditions,
  ...
  createRule(e, a) {
    return new xn(this.sheet, e, a, this);
  }
}, T1 = class {
  constructor(f, e) {
  ...
  addRule(f) {
    ...
    return Ze(e) ? e : (this.storedClasses[f.key] = f.hash, this.storedStyles[f.hash] = [f.property, f.value], this.append(f.toString()), f.hash);
  }
};
function ya(f, e) {
  for (const a in f)
...
function v(...f) {
  const e = f.reduce((a, n) => (n instanceof Set ? a.push(...n) : typeof n == "string" ? a.push(n) : Array.isArray(n) ? a.push(v(...n)) : typeof n == "object" && Object.entries(n).forEach(([i, r]) => {
    r && a.push(i);
  }), a), []);
  return Je(e, " ").trim();
}
function x1(f, e) {
  ...
  function n(i) {
    const r = {};
    return En(a, i, new D1(a)).forEach(
      ([u, d, s]) => {
        He(a, d, s).forEach(
          (c) => {
            o(u, c);
...
function O() {
  return O = Object.assign ? Object.assign.bind() : function(f) {
...
function A1(f, e) {
  f.prototype = Object.create(e.prototype), f.prototype.constructor = f, Ma(f, e);
}
function Ma(f, e) {
  return Ma = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(n, i) {
...
function P1(f, e) {
  if (f) {
    if (typeof f == "string") return an(f, e);
    ...
    if (a === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a)) return an(f, e);
  }
}
function an(f, e) {
  (e == null || e > f.length) && (e = f.length);
  for (var a = 0, n = new Array(e); a < e; a++) n[a] = f[a];
  return n;
}
function R1(f, e) {
  var a = typeof Symbol < "u" && f[Symbol.iterator] || f["@@iterator"];
  if (a) return (a = a.call(f)).next.bind(a);
  if (Array.isArray(f) || (a = P1(f)) || e) {
    a && (f = a);
    var n = 0;
    return function() {
      return n >= f.length ? {
...
var J = /* @__PURE__ */ x1("epr", null), Qe = {
  display: "none",
  opacity: "0",
  pointerEvents: "none",
  visibility: "hidden",
  overflow: "hidden"
}, ha = /* @__PURE__ */ J.create({
  hidden: /* @__PURE__ */ O({
    ".": h.hidden
  }, Qe)
}), Q1 = /* @__PURE__ */ vn(function() {
  return g("style", {
  ...
  ".epr-main": {
    ":has(input:not(:placeholder-shown))": {
      ...
      hiddenOnSearch: /* @__PURE__ */ O({
        ".": h.hiddenOnSearch
      }, Qe)
    },
    ":has(input:placeholder-shown)": {
      visibleOnSearchOnly: Qe
    }
  },
  hiddenOnReactions: {
  ...
  ".EmojiPickerReact:not(.epr-search-active)": {
    ...
    visibleOnSearchOnly: /* @__PURE__ */ O({
...
var gf, J1 = [y.SUGGESTED, y.CUSTOM, y.SMILEYS_PEOPLE, y.ANIMALS_NATURE, y.FOOD_DRINK, y.TRAVEL_PLACES, y.ACTIVITIES, y.OBJECTS, y.SYMBOLS, y.FLAGS], O1 = {
  name: "Recently Used",
  category: y.SUGGESTED
}, Qn = (gf = {}, gf[y.SUGGESTED] = {
  category: y.SUGGESTED,
  ...
  category: y.SMILEYS_PEOPLE,
  name: "Smileys & People"
}, gf[y.ANIMALS_NATURE] = {
  category: y.ANIMALS_NATURE,
  name: "Animals & Nature"
}, gf[y.FOOD_DRINK] = {
  category: y.FOOD_DRINK,
  name: "Food & Drink"
}, gf[y.TRAVEL_PLACES] = {
  category: y.TRAVEL_PLACES,
  name: "Travel & Places"
}, gf[y.ACTIVITIES] = {
  category: y.ACTIVITIES,
  name: "Activities"
}, gf[y.OBJECTS] = {
  category: y.OBJECTS,
  name: "Objects"
...
function Yn(f) {
  return J1.map(function(e) {
    return O({}, Qn[e], f && f[e] && f[e]);
  });
}
function pa(f) {
  return f.category;
...
function U1(f, e) {
  ...
  var n = {};
  e.suggestionMode === we.RECENT && (n[y.SUGGESTED] = O1);
  var i = Yn(n);
  return (a = f) != null && a.length ? f.map(function(r) {
    return typeof r == "string" ? nn(r, n[r]) : O({}, nn(r.category, n[r.category]), r);
  }) : i;
}
function nn(f, e) {
  return e === void 0 && (e = {}), Object.assign(Qn[f], e);
}
var B1 = "https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/", G1 = "https://cdn.jsdelivr.net/npm/emoji-datasource-facebook/img/facebook/64/", Z1 = "https://cdn.jsdelivr.net/npm/emoji-datasource-twitter/img/twitter/64/", H1 = "https://cdn.jsdelivr.net/npm/emoji-datasource-google/img/google/64/";
function W1(f) {
  switch (f) {
    case df.TWITTER:
      return Z1;
...
var F1 = [], _1 = [
  ...
  symbols: fi,
  flags: ei
}, Oe = [Cf.NEUTRAL, Cf.LIGHT, Cf.MEDIUM_LIGHT, Cf.MEDIUM, Cf.MEDIUM_DARK, Cf.DARK], ai = /* @__PURE__ */ Object.entries(Cf).reduce(function(f, e) {
  var a = e[0], n = e[1];
  return f[n] = a, f;
}, {}), ni = /* @__PURE__ */ Oe.reduce(function(f, e) {
  var a;
...
var ge = {};
setTimeout(function() {
  We.reduce(function(f, e) {
    return On(e), f;
  }, ge);
});
function On(f) {
  var e = ye(f).flat().join("").toLowerCase().replace(/[^a-zA-Z\d]/g, "").split("");
  e.forEach(function(a) {
    var n;
    ge[a] = (n = ge[a]) != null ? n : {}, ge[a][tf(f)] = f;
  });
}
function ye(f) {
  var e;
  return (e = f[Mf.name]) != null ? e : [];
}
function ii(f) {
  return parseFloat(f[Mf.added_in]);
}
function wa(f) {
  return f ? ye(f)[0] : "";
}
function va(f) {
  ...
  return ni[n] ? e.join("-") : f;
}
function tf(f, e) {
  var a, n = f[Mf.unified];
  return !e || !ne(f) ? n : (a = ti(f, e)) != null ? a : n;
}
function ri(f) {
  var e;
  return (e = Le == null ? void 0 : Le[f]) != null ? e : [];
}
function Un(f, e) {
  return "" + W1(e) + f + ".png";
}
function he(f) {
  var e;
  return (e = f[Mf.variations]) != null ? e : [];
}
function ne(f) {
  return he(f).length > 0;
}
function ti(f, e) {
  return e ? he(f).find(function(a) {
    return a.includes(e);
  }) : tf(f);
}
function ee(f) {
...
var We = /* @__PURE__ */ Object.values(Le).flat();
function oi(f) {
  Le[y.CUSTOM].length = 0, f.forEach(function(e) {
    var a = ui(e);
    Le[y.CUSTOM].push(a), !Xf[a[Mf.unified]] && (We.push(a), Xf[a[Mf.unified]] = a, On(a));
  });
}
function ui(f) {
  var e;
  return e = {}, e[Mf.name] = f.names.map(function(a) {
    return a.toLowerCase();
  }), e[Mf.unified] = f.id.toLowerCase(), e[Mf.added_in] = "0", e[Mf.imgUrl] = f.imgUrl, e;
}
var Xf = {};
setTimeout(function() {
  We.reduce(function(f, e) {
    return f[tf(e)] = e, ne(e) && he(e).forEach(function(a) {
      f[a] = e;
    }), f;
  }, Xf);
});
function di(f) {
  var e = f.split("-"), a = e[1];
  return Oe.includes(a) ? a : null;
}
var ci = ["2640-fe0f", "2642-fe0f", "2695-fe0f"], Ue = "Search", si = "No results found", Bn = " found. Use up and down arrow keys to navigate.", li = "1 result" + Bn, gi = "%n results" + Bn;
function rn(f) {
  var e, a;
  f === void 0 && (f = {});
  var n = Gn(), i = Object.assign(n.previewConfig, (e = f.previewConfig) != null ? e : {}), r = Object.assign(n, f), o = U1(f.categories, {
    suggestionMode: r.suggestedEmojisMode
  });
  r.hiddenEmojis.forEach(function(d) {
    r.unicodeToHide.add(d);
  }), oi((a = r.customEmojis) != null ? a : []);
  var u = r.searchDisabled ? fe.PREVIEW : r.skinTonePickerLocation;
  return O({}, r, {
    categories: o,
    previewConfig: i,
...
function Gn() {
  return {
    ...
    searchPlaceholder: Ue,
    skinTonePickerLocation: fe.SEARCH,
    skinTonesDisabled: !1,
    style: {},
    suggestedEmojisMode: we.FREQUENT,
    theme: qf.LIGHT,
    unicodeToHide: new Set(ci),
    width: 350,
...
var Mi = {
  ...
  showPreview: !0
}, wi = ["children"], Zn = /* @__PURE__ */ ja(/* @__PURE__ */ Gn());
function Li(f) {
  var e = f.children, a = Pn(f, wi), n = bi(a);
  return g(Zn.Provider, {
    value: n
  }, e);
}
function bi(f) {
...
function tn(f, e) {
  e === void 0 && (e = 0);
  var a = R(f), n = a[0], i = a[1], r = V(null);
  function o(u) {
    return new Promise(function(d) {
      var s;
      r.current && clearTimeout(r.current), r.current = (s = window) == null ? void 0 : s.setTimeout(function() {
        i(u), d(u);
      }, e);
    });
  }
...
function Hn() {
  ...
  return Yf(function() {
    var a = parseFloat("" + e);
    return !e || Number.isNaN(a) ? f.current : We.reduce(function(n, i) {
      return mi(i, a) && (n[tf(i)] = !0), n;
    }, f.current);
  }, [e]);
}
function Wn() {
...
function yi(f) {
  var e = f.children, a = Hn(), n = Ni(), i = Qi(), r = V(ge), o = V(!1), u = V(!1), d = V(a), s = tn(Date.now(), 200), c = tn("", 100), w = R(!1), L = R(n), j = R(null), I = R(/* @__PURE__ */ new Set()), T = R(null), Q = R(i), Y = R(!1), C = Y[0], K = Y[1];
  return Ci(K), g(wf.Provider, {
    value: {
      activeCategoryState: j,
      activeSkinTone: L,
      disallowClickRef: o,
      disallowMouseRef: u,
      disallowedEmojisRef: d,
      emojiVariationPickerState: T,
      emojisThatFailedToLoadState: I,
      filterRef: r,
      isPastInitialLoad: C,
      searchTerm: c,
      skinToneFanOpenState: w,
      suggestedUpdateState: s,
      reactionsModeState: Q
    }
  }, e);
}
var wf = /* @__PURE__ */ ja({
  ...
  activeSkinTone: [Cf.NEUTRAL, function() {
  }],
  disallowClickRef: {
    current: !1
  },
...
function Ia() {
  var f = cf(wf), e = f.filterRef;
  return e;
}
function hi() {
  var f = cf(wf), e = f.disallowClickRef;
  return e;
}
function Na() {
  var f = cf(wf), e = f.disallowMouseRef;
  return e;
}
function ie() {
  var f = cf(wf), e = f.reactionsModeState;
  return e;
}
function Fe() {
  var f = cf(wf), e = f.searchTerm;
  return e;
}
function ka() {
  var f = cf(wf), e = f.activeSkinTone;
  return e;
}
function Fn() {
  var f = cf(wf), e = f.emojisThatFailedToLoadState;
  return e;
}
function pi() {
  var f = cf(wf), e = f.isPastInitialLoad;
  return e;
}
function re() {
  var f = cf(wf), e = f.emojiVariationPickerState;
  return e;
}
function pe() {
  var f = cf(wf), e = f.skinToneFanOpenState;
  return e;
}
function _n() {
  var f = cf(wf), e = f.suggestedUpdateState, a = e[0], n = e[1];
  return [a, function() {
    n(Date.now());
  }];
}
...
function Ii() {
  var f, e = G(), a = e.searchPlaceHolder, n = e.searchPlaceholder;
  return (f = [a, n].find(function(i) {
    return i !== Ue;
  })) != null ? f : Ue;
}
function Ni() {
  var f = G(), e = f.defaultSkinTone;
  return e;
}
function Xn() {
  var f = G(), e = f.allowExpandReactions;
  return e;
}
function $n() {
  var f = G(), e = f.skinTonesDisabled;
  return e;
}
function Of() {
  var f = G(), e = f.emojiStyle;
  return e;
}
function ki() {
  var f = G(), e = f.autoFocusSearch;
  return e;
}
function qn() {
  var f = G(), e = f.categories;
  return e;
}
function Si() {
  var f = G(), e = f.customEmojis;
  return e;
}
function Di() {
  var f = G(), e = f.open;
...
function Ti(f) {
  var e = Kn(), a = e.current, n = ie(), i = n[1], r = a.onEmojiClick || function() {
  }, o = a.onReactionClick;
  return f === be.REACTIONS && o ? function() {
    for (var u = arguments.length, d = new Array(u), s = 0; s < u; s++)
      d[s] = arguments[s];
    return o.apply(void 0, d.concat([{
...
function xi() {
  var f = Kn(), e = f.current;
  return e.onSkinToneChange || function() {
  };
}
function f0() {
  var f = G(), e = f.previewConfig;
  return e;
}
function zi() {
  var f = G(), e = f.theme;
...
function Ei() {
  var f = G(), e = f.suggestedEmojisMode;
  return e;
}
function Ai() {
  var f = G(), e = f.lazyLoadEmojis;
  return e;
}
function Pi() {
  var f = G(), e = f.className;
  return e;
}
function Ri() {
  var f = G(), e = f.height, a = f.width, n = f.style;
  return O({
    height: on(e),
    width: on(a)
  }, n);
...
function Qi() {
  var f = G(), e = f.reactionsDefaultOpen;
  return e;
}
function Yi() {
  var f = G(), e = f.emojiVersion;
  return e;
}
function e0() {
  var f = G(), e = f.searchDisabled;
  return e;
}
function a0() {
  var f = G(), e = f.skinTonePickerLocation;
  return e;
}
function Ji() {
  var f = G(), e = f.unicodeToHide;
  return e;
}
function Oi() {
  var f = G(), e = f.reactions;
  return e;
}
function Uf() {
  var f = G(), e = f.getEmojiUrl;
  return e;
}
function on(f) {
...
function Ui(f) {
  var e = f > 0, a = f > 1;
  return e ? a ? gi.replace("%n", f.toString()) : li : si;
}
function _e() {
  var f = Fe(), e = f[0];
  return !!e;
...
function Bi(f) {
  var e = f.children, a = V(null), n = V(null), i = V(null), r = V(null), o = V(null), u = V(null), d = V(null), s = V(null);
  return g(t0.Provider, {
    value: {
      AnchoredEmojiRef: n,
      BodyRef: i,
...
function ve() {
  return Ef().PickerMainRef;
}
function Ve() {
  return Ef().AnchoredEmojiRef;
}
function o0() {
  var f = Ve();
  return function(e) {
    e === null && f.current !== null && sf(f.current), f.current = e;
  };
}
function Lf() {
  return Ef().BodyRef;
...
function Gi() {
  return Ef().ReactionsRef;
}
function Af() {
  return Ef().SearchInputRef;
}
function Sa() {
  return Ef().SkinTonePickerRef;
}
function Da() {
  return Ef().CategoryNavigationRef;
}
function Zi() {
  return Ef().VariationPickerRef;
}
function u0(f, e) {
  e === void 0 && (e = 0);
  var a = p0(f);
...
function Ke(f) {
  if (!(!f || !Rr(f)) && !f.closest(q(h.variationPicker))) {
    var e = I0(f), a = v0(f);
    Hi(e, -(Pa(Pf(f)) - a));
  }
}
...
function qi(f) {
  if (!f)
    return null;
  var e = x0(f), a = Pf(e), n = m0(e, f), i = C0(e, f), r = j0(e, f);
  if (i === 0) {
    var o = $e(a);
    return o ? y0(
      ae(o),
...
function rr() {
  var f = Af(), e = Ta();
  return function(n) {
    f.current ? (f.current.value = "" + f.current.value + n, e(La(f.current.value))) : e(La(n));
  };
}
function tr() {
  var f = Af(), e = Ia(), a = ir(), n = Ta(), i = Fe(), r = i[0], o = lr(e.current, r);
  return {
    onChange: u,
    searchTerm: r,
    SearchInputRef: f,
    statusSearchResults: o
  };
  function u(d) {
    var s = e.current, c = d.toLowerCase();
    if (s != null && s[c] || c.length <= 1)
      return n(c);
    var w = sr(c, s);
    if (!w)
      return n(c);
    a(function(L) {
      var j;
      return Object.assign(L, (j = {}, j[c] = or(w, c), j));
    }), n(c);
  }
}
function Ta() {
...
function ur(f, e) {
  return ye(f).some(function(a) {
    return a.includes(e);
  });
}
function dr() {
  var f = Ia(), e = f.current, a = Fe(), n = a[0];
  return function(i) {
    return cr(i, e, n);
  };
}
...
function Mr() {
  var f = ve(), e = g0(), a = Wi(), n = Af(), i = Gf(), r = d0(), o = er(), u = Bf(), d = Yf(function() {
    return function(c) {
      var w = c.key;
      switch (o(), w) {
  ...
  B(function() {
    var s = f.current;
    if (s)
      return s.addEventListener("keydown", d), function() {
        s.removeEventListener("keydown", d);
      };
  }, [f, n, a, d]);
}
function wr() {
  var f = nr(), e = ve(), a = Lf(), n = Af(), i = pe(), r = i[1], o = L0(), u = xa(), d = Yf(function() {
    return function(c) {
      var w = c.key;
      switch (w) {
        case W.ArrowRight:
          if (!u)
            return;
          c.preventDefault(), r(!0), f();
          break;
        case W.ArrowDown:
          c.preventDefault(), o();
          break;
        case W.Enter:
          c.preventDefault(), Fi(a.current);
          break;
      }
    };
  }, [f, o, r, a, u]);
...
function Lr() {
  var f = Sa(), e = Gf(), a = Af(), n = L0(), i = pe(), r = i[0], o = i[1], u = w0(), d = xa(), s = za(), c = Yf(function() {
    return (
  ...
  B(function() {
    var w = f.current;
    if (w)
      return w.addEventListener("keydown", c), function() {
        w.removeEventListener("keydown", c);
      };
  }, [f, a, r, c]);
}
function br() {
  var f = Gf(), e = Da(), a = Lf(), n = za(), i = Yf(function() {
    return function(o) {
      var u = o.key;
      switch (u) {
        case W.ArrowUp:
          ...
          break;
        case W.ArrowRight:
          o.preventDefault(), i0(je());
          break;
        case W.ArrowLeft:
          o.preventDefault(), n0(je());
          break;
        case W.ArrowDown:
          o.preventDefault(), Xe(a.current);
          break;
        default:
          n(o);
          break;
...
function jr() {
  var f = Lf(), e = mr(), a = M0(), n = d0(), i = Bf(), r = za(), o = Yf(function() {
    return (
      // eslint-disable-next-line complexity
      (function(d) {
        var s = d.key, c = yf(je());
        switch (s) {
          case W.ArrowRight:
            d.preventDefault(), Vi(c);
            break;
          case W.ArrowLeft:
            d.preventDefault(), Ki(c);
            break;
          case W.ArrowDown:
  ...
  B(function() {
    var u = f.current;
    if (u)
      return u.addEventListener("keydown", o), function() {
...
function za() {
  var f = rr(), e = Gf(), a = e0(), n = Bf();
  return function(r) {
    var o = r.key;
    Cr(r) || a || o.match(/(^[a-zA-Z0-9]$){1}/) && (r.preventDefault(), n(), e(), f(o));
  };
}
function Cr(f) {
...
function yr(f, e, a) {
  if (e && a !== df.NATIVE) {
    var n = tf(e);
    cn.has(n) || (he(e).forEach(function(i) {
      var r = f(i, a);
      hr(r);
    }), cn.add(n));
  }
...
var vr = ["width", "height"], b0 = 40;
function Ir(f) {
  var e = f.children;
  return g(yi, null, g(Nr, null, e));
}
function Nr(f) {
  var e, a = f.children, n = ie(), i = n[0], r = zi(), o = _e(), u = ve(), d = Pi(), s = Ri();
  gr(), pr();
  var c = s || {}, w = c.width, L = c.height, j = Pn(c, vr);
  return g("aside", {
    className: v(ce.main, ce.baseVariables, r === qf.DARK && ce.darkTheme, r === qf.AUTO && ce.autoThemeDark, (e = {}, e[h.searchActive] = o, e), i && ce.reactionsMenu, d),
    ref: u,
    style: O({}, j, !i && {
      height: L,
      width: w
...
var sn = {
...
}, ce = /* @__PURE__ */ J.create({
  main: {
    ".": ["epr-main", h.emojiPicker],
    position: "relative",
    display: "flex",
  ...
  baseVariables: {
    "--": {
      ...
      "--epr-category-label-height": b0 + "px",
      /*  Emoji */
      "--epr-emoji-size": "30px",
...
function xr(f, e, a) {
  if (!f || !e.length)
    return null;
  var n = f.getBoundingClientRect().top, i = f.getBoundingClientRect().bottom, r = n + Er(f), o = e.find(function(u) {
    var d = u.getBoundingClientRect().top, s = u.getBoundingClientRect().bottom, c = u.clientHeight * a, w = d + c, L = s - c;
    return w < r ? !1 : w >= n && w <= i || L >= n && L <= i;
  });
  return o || null;
}
function zr(f) {
...
function Er(f) {
  for (var e = Array.from(f.querySelectorAll(q(h.label))), a = 0, n = e; a < n.length; a++) {
...
var Be = "button" + /* @__PURE__ */ q(h.emoji), Ar = /* @__PURE__ */ [Be, q(h.visible), ":not(" + q(h.hidden) + ")"].join("");
function yf(f) {
  var e;
  return (e = f == null ? void 0 : f.closest(Be)) != null ? e : null;
}
function Aa(f) {
  var e = N0(f), a = Ra(f);
  if (!e)
...
function Pr(f) {
  var e;
  return !!(f != null && f.matches(Be) || !(f == null || (e = f.parentElement) == null) && e.matches(Be));
}
function ln(f) {
  var e;
...
function Pa(f) {
  ...
  if (!f)
    return 0;
  var n = f.querySelector(q(h.categoryContent));
  return ((e = f == null ? void 0 : f.clientHeight) != null ? e : 0) - ((a = n == null ? void 0 : n.clientHeight) != null ? a : 0);
}
function Rr(f) {
  return f ? v0(f) < Pa(Pf(f)) : !1;
}
function p0(f) {
  return f ? f.matches(q(h.scrollBody)) ? f : f.querySelector(q(h.scrollBody)) : null;
}
function v0(f) {
  var e, a;
  return f ? h0(f) - ((e = (a = I0(f)) == null ? void 0 : a.scrollTop) != null ? e : 0) : 0;
}
function I0(f) {
  var e;
  return f && (e = f.closest(q(h.scrollBody))) != null ? e : null;
}
function Qr(f) {
  var e = yf(f), a = Pf(e);
  return Mn(e) + Mn(a);
...
function Ra(f) {
  var e;
  return (e = Yr(yf(f), "unified")) != null ? e : null;
}
function N0(f) {
  var e = Ra(f);
  return e ? va(e) : null;
...
function Qa(f) {
  return f.classList.contains(h.visible);
}
function S0(f) {
  return f ? f.classList.contains(h.hidden) : !0;
}
function ae(f) {
  return f ? Array.from(f.querySelectorAll(Ar)) : [];
}
function D0(f) {
  if (!f) return null;
  var e = ae(f), a = e.slice(-1), n = a[0];
  return n ? Qa(n) ? n : Ya(n) : null;
}
function T0(f) {
  var e = f.nextElementSibling;
  return e ? Qa(e) ? e : T0(e) : Ja(qe(f));
}
function Ya(f) {
  var e = f.previousElementSibling;
  return e ? Qa(e) ? e : Ya(e) : D0($e(f));
}
function Ja(f) {
  if (!f)
    return null;
...
function qe(f) {
  ...
  return a ? S0(a) ? qe(a) : a : null;
}
function Pf(f) {
  return f ? f.closest(q(h.category)) : null;
}
function x0(f) {
  return f ? f.closest(q(h.categoryContent)) : null;
}
function z0(f) {
...
var E0 = "epr_suggested";
function A0(f) {
  try {
    var e, a, n;
    if (!((e = window) != null && e.localStorage))
      return [];
    var i = JSON.parse((a = (n = window) == null ? void 0 : n.localStorage.getItem(E0)) != null ? a : "[]");
    return f === we.FREQUENT ? i.sort(function(r, o) {
      return o.count - r.count;
    }) : i;
  } catch {
    return [];
  }
...
function Or(f, e) {
  var a = A0(), n = tf(f, e), i = tf(f), r = a.find(function(d) {
    var s = d.unified;
    return s === n;
  }), o;
  r ? o = [r].concat(a.filter(function(d) {
    return d !== r;
  })) : (r = {
    unified: n,
    original: i,
    count: 0
  }, o = [r].concat(a)), r.count++, o.length = Math.min(o.length, 14);
  try {
    var u;
    (u = window) == null || u.localStorage.setItem(E0, JSON.stringify(o));
  } catch {
  }
}
function Ur(f) {
  return f.category === y.CUSTOM;
}
function P0(f) {
...
function R0(f, e) {
  ...
  B(function() {
    if (f.current) {
      var C = f.current;
      return C.addEventListener("click", T, {
        passive: !0
      }), C.addEventListener("mousedown", Q, {
        passive: !0
      }), C.addEventListener("mouseup", Y, {
        passive: !0
      }), function() {
        C == null || C.removeEventListener("click", T), C == null || C.removeEventListener("mousedown", Q), C == null || C.removeEventListener("mouseup", Y);
      };
    }
  }, [f, T, Q, Y]);
}
...
function Br(f, e, a, n) {
  ...
  return {
    ...
    getImageUrl: function(d) {
      return d === void 0 && (d = a ?? df.APPLE), n(o, d);
    },
    imageUrl: n(o, a ?? df.APPLE),
    isCustom: !1,
    names: i,
    unified: o,
    unifiedWithoutSkinTone: tf(f)
  };
}
function Ie(f) {
  return g("button", Object.assign({
    type: "button"
  }, f, {
    className: v(Gr.button, f.className)
  }), f.children);
}
var Gr = /* @__PURE__ */ J.create({
  button: {
    ".": "epr-btn",
    cursor: "pointer",
    border: "0",
...
function Zr(f) {
  var e, a = f.emojiNames, n = f.unified, i = f.hidden, r = f.hiddenOnSearch, o = f.showVariations, u = o === void 0 ? !0 : o, d = f.hasVariations, s = f.children, c = f.className, w = f.noBackground, L = w === void 0 ? !1 : w;
  return g(Ie, {
    className: v(oa.emoji, i && ha.hidden, r && Jf.hiddenOnSearch, (e = {}, e[h.visible] = !i && !r, e), !!(d && u) && oa.hasVariations, L && oa.noBackground, c),
    "data-unified": n,
    "aria-label": Hr(a),
    "data-full-name": a
  }, s);
...
function Ln(f) {
  var e = f.emojiName, a = f.style, n = f.lazyLoad, i = n === void 0 ? !1 : n, r = f.imgUrl, o = f.onError, u = f.className;
  return g("img", {
    src: r,
    alt: e,
    className: v(Wr.emojiImag, Ge.external, Ge.common, u),
    loading: i ? "lazy" : "eager",
    onError: o,
    style: a
  });
}
var Wr = /* @__PURE__ */ J.create({
  emojiImag: {
    ".": "epr-emoji-img",
    maxWidth: "var(--epr-emoji-fullsize)",
    maxHeight: "var(--epr-emoji-fullsize)",
...
function Fr(f) {
  ...
  return g("span", {
    className: v(_r.nativeEmoji, Ge.common, Ge.external, n),
    "data-unified": e,
    style: a
  }, z0(e));
}
var _r = /* @__PURE__ */ J.create({
  nativeEmoji: {
    ".": "epr-emoji-native",
...
function ba(f) {
  var e = f.emoji, a = f.unified, n = f.emojiStyle, i = f.size, r = f.lazyLoad, o = f.getEmojiUrl, u = o === void 0 ? Un : o, d = f.className, s = Fn(), c = s[1], w = {};
  i && (w.width = w.height = w.fontSize = i + "px");
  var L = e || ee(a);
  if (!L)
    return null;
  if (P0(L))
    return g(Ln, {
      style: w,
      emojiName: a,
      emojiStyle: df.NATIVE,
      lazyLoad: r,
      imgUrl: L.imgUrl,
      onError: j,
      className: d
    });
  return g(ma, null, n === df.NATIVE ? g(Fr, {
    unified: a,
    style: w,
    className: d
  }) : g(Ln, {
  ...
  function j() {
    c(function(I) {
      return new Set(I).add(a);
    });
  }
}
function fa(f) {
  var e = f.emoji, a = f.unified, n = f.hidden, i = f.hiddenOnSearch, r = f.emojiStyle, o = f.showVariations, u = o === void 0 ? !0 : o, d = f.size, s = f.lazyLoad, c = f.getEmojiUrl, w = f.className, L = f.noBackground, j = L === void 0 ? !1 : L, I = ne(e);
  return g(Zr, {
    hasVariations: I,
    showVariations: u,
    hidden: n,
...
function Kr() {
  ...
  return g(Ie, {
    ...
    tabIndex: 0,
    className: v(Xr.plusSign),
    onClick: function() {
      return e(!1);
    }
  });
}
var Xr = /* @__PURE__ */ J.create(/* @__PURE__ */ O({
  plusSign: {
    fontSize: "20px",
    padding: "17px",
...
function $r() {
  var f = ie(), e = f[0], a = Gi(), n = Oi();
  R0(a, be.REACTIONS);
  var i = Of(), r = Xn(), o = Uf();
  return e ? g("ul", {
    className: v(bn.list, !e && ha.hidden),
    ref: a
  }, n.map(function(u) {
    return g("li", {
      key: u
      ...
      unified: u,
      showVariations: !1,
      className: v(bn.emojiButton),
      noBackground: !0,
      getEmojiUrl: o
    }));
  }), r ? g("li", null, g(Kr, null)) : null) : null;
}
var bn = /* @__PURE__ */ J.create({
  list: {
    listStyle: "none",
    margin: "0",
    padding: "0 5px",
...
function Q0(f) {
  var e = f.categoryConfig, a = f.children, n = f.hidden, i = f.hiddenOnSearch, r = pa(e), o = Jn(e);
  return g("li", {
    className: v(ua.category, n && ha.hidden, i && Jf.hiddenOnSearch),
    "data-name": r,
    "aria-label": o
  }, g("h2", {
    className: v(ua.label)
  }, o), g("div", {
    className: v(ua.categoryContent)
  }, a));
}
var ua = /* @__PURE__ */ J.create({
  category: {
    ".": h.category,
    ":not(:has(.epr-visible))": {
      display: "none"
...
function et() {
  var f = R(da), e = f[0], a = f[1];
  return B(function() {
    a(!0), da = !0;
  }, []), e || da;
}
function at(f) {
  var e = f.categoryConfig, a = _n(), n = a[0], i = et(), r = Ei(), o = Uf(), u = Yf(
    function() {
      var c;
      return (c = A0(r)) != null ? c : [];
    },
...
function nt() {
  var f = qn(), e = V(0);
  return g("ul", {
    className: v(rt.emojiList)
  }, f.map(function(a) {
    var n = pa(a);
    return n === y.SUGGESTED ? g(at, {
      key: n,
      categoryConfig: a
    }) : g(t1, {
      key: n
...
function it(f) {
  var e = f.category, a = f.categoryConfig, n = f.renderdCategoriesCountRef, i = ft(), r = Ai(), o = Of(), u = pi(), d = ka(), s = d[0], c = Wn(), w = Uf(), L = !$n(), j = !u && n.current > 0 ? [] : ri(e);
  j.length > 0 && n.current++;
  var I = 0, T = j.map(function(Q) {
    var Y = tf(Q, s), C = i(Q), K = C.failedToLoad, ff = C.filteredOut, ef = C.hidden, af = c(Q);
    return (ef || af) && I++, af ? null : g(fa, {
      showVariations: L,
      key: Y,
      emoji: Q,
      unified: Y,
...
function ot() {
  var f = Ve(), e = Zi(), a = re(), n = a[0], i = Of(), r = dt(e), o = r.getTop, u = r.getMenuDirection, d = o0(), s = ut(e), c = Uf(), w = yf(f.current), L = !!(n && w && ne(n) && w.classList.contains(h.emojiHasVariations));
  B(function() {
    L && Xe(e.current);
  }, [e, L, f]);
  var j, I;
  return !L && f.current ? d(null) : (j = o(), I = s()), g("div", {
    ref: e,
    className: v(Ee.variationPicker, u() === $f.Down && Ee.pointingUp, L && Ee.visible),
    style: {
      top: j
    }
  }, L && n ? [tf(n)].concat(he(n)).slice(0, 6).map(function(T) {
    return g(fa, {
      key: T,
      emoji: n,
      unified: T,
...
function dt(f) {
  ...
  function r() {
    ...
    var u = ln(f.current);
    if (e.current) {
      var d, s = a.current, c = yf(e.current), w = ln(c);
      o = h0(c);
      var L = (d = s == null ? void 0 : s.scrollTop) != null ? d : 0;
      L > o - u && (n = $f.Down, o += w + u);
    }
    return o - u;
  }
}
var Ee = /* @__PURE__ */ J.create(/* @__PURE__ */ O({
  variationPicker: {
    ".": h.variationPicker,
    position: "absolute",
    right: "15px",
...
function ct() {
  var f = Lf();
  return qr(f), R0(f, be.PICKER), ar(), g("div", {
    className: v(st.body, Jf.hiddenOnReactions),
    ref: f
  }, g(ot, null), g(nt, null));
}
var st = /* @__PURE__ */ J.create({
  body: {
    ".": h.scrollBody,
    flex: "1",
    overflowY: "scroll",
...
function gt(f, e) {
  ...
  B(function() {
    ...
    r == null || r.addEventListener("keydown", d, {
      passive: !0
    }), r == null || r.addEventListener("mouseover", s, !0), r == null || r.addEventListener("focus", o, !0), r == null || r.addEventListener("mouseout", u, {
      passive: !0
    ...
    function o(c) {
      ...
      if (!w)
        return u();
      var L = k0(w), j = L.unified, I = L.originalUnified;
      if (!j || !I)
        return u();
      e({
        unified: j,
    ...
    function s(c) {
      if (!n()) {
        var w = yf(c.target);
        if (w) {
          var L = lt(w, r), j = w.getBoundingClientRect().height;
          if (L < j)
            return Mt(w, e);
          sf(w);
        }
    ...
    return function() {
      r == null || r.removeEventListener("mouseover", s), r == null || r.removeEventListener("mouseout", u), r == null || r.removeEventListener("focus", o, !0), r == null || r.removeEventListener("blur", u, !0), r == null || r.removeEventListener("keydown", d);
    };
  }, [a, f, e, n, i]);
}
function Mt(f, e) {
  var a, n = k0(f), i = n.unified, r = n.originalUnified;
...
function Y0(f) {
  var e = f.children, a = f.className, n = f.style, i = n === void 0 ? {} : n, r = f.direction, o = r === void 0 ? me.ROW : r;
  return g("div", {
    style: O({}, i),
    className: v(jn.flex, a, jn[o])
  }, e);
}
var jn = /* @__PURE__ */ J.create((Ae = {
  flex: {
    display: "flex"
  }
}, Ae[me.ROW] = {
...
function bt(f) {
  ...
  return g(Ie, {
    style: r,
    onClick: a,
    className: v("epr-tone-" + i, ca.tone, !e && ca.closedTone, n && ca.active),
    "aria-pressed": n,
    "aria-label": "Skin tone " + ai[i]
  });
}
var ca = /* @__PURE__ */ J.create({
  closedTone: {
    opacity: "0",
    zIndex: "0"
  },
...
function J0(f) {
  var e = f.direction, a = e === void 0 ? Ce.HORIZONTAL : e, n = Sa(), i = $n(), r = pe(), o = r[0], u = r[1], d = ka(), s = d[0], c = d[1], w = xi(), L = Bf(), j = Gf();
  if (i)
    return null;
  var I = le * Oe.length + "px", T = o ? I : le + "px", Q = a === Ce.VERTICAL;
  return g(ea, {
    className: v(se.skinTones, Q && se.vertical, o && se.open, Q && o && se.verticalShadow),
    style: Q ? {
      flexBasis: T,
      height: T
    } : {
    ...
    return g(bt, {
      ...
      isOpen: o,
      style: {
        transform: v(Q ? "translateY(-" + C * (o ? le : 0) + "px)" : "translateX(-" + C * (o ? le : 0) + "px)", o && K && "scale(1.3)")
      },
      isActive: K,
      onClick: function() {
        o ? (c(Y), w(Y), j()) : u(!0), L();
...
function mt() {
  var f = f0(), e = w0(), a = ie(), n = a[0];
  return f.showPreview ? g(Y0, {
    className: v(Me.preview, Jf.hiddenOnReactions, n && Me.hideOnReactions)
  }, g(Ct, null), g(wt, null), e ? g(jt, null) : null) : null;
}
function Ct() {
  var f, e = f0(), a = R(null), n = a[0], i = a[1], r = Of(), o = re(), u = o[0], d = Uf();
  gt(e.showPreview, i);
  var s = ee((f = n == null ? void 0 : n.unified) != null ? f : n == null ? void 0 : n.originalUnified), c = s != null && n != null;
  return g(w, null);
  function w() {
    var L = u ?? ee(e.defaultEmoji);
    if (!L)
      return null;
    var j = u ? wa(u) : e.defaultCaption;
    return g(ma, null, g("div", null, c ? g(ba, {
      unified: n == null ? void 0 : n.unified,
      emoji: s,
      emojiStyle: r,
      size: 45,
      getEmojiUrl: d,
      className: v(Me.emoji)
    }) : L ? g(ba, {
      unified: tf(L),
      emoji: L,
      emojiStyle: r,
      ...
      className: v(Me.label)
    }, c ? wa(s) : j));
  }
}
var Me = /* @__PURE__ */ J.create({
  preview: {
    alignItems: "center",
...
function ht(f) {
  ...
  B(function() {
    var a = /* @__PURE__ */ new Map(), n = e.current, i = new IntersectionObserver(function(r) {
      if (n) {
        for (var o = R1(r), u; !(u = o()).done; ) {
          var d = u.value, s = yt(d.target);
          a.set(s, d.intersectionRatio);
        }
        var c = Array.from(a), w = c[c.length - 1];
        if (w[1] == 1)
          return f(w[0]);
        for (var L = 0, j = c; L < j.length; L++) {
          var I = j[L], T = I[0], Q = I[1];
          if (Q) {
            f(T);
            break;
          }
    ...
    n == null || n.querySelectorAll(q(h.category)).forEach(function(r) {
      i.observe(r);
    });
  }, [e, f]);
}
...
function Nt(f) {
  var e, a = f.isActiveCategory, n = f.category, i = f.allowNavigation, r = f.categoryConfig, o = f.onClick;
  return g(Ie, {
    tabIndex: i ? 0 : -1,
    className: v(St.catBtn, Jf.categoryBtn, "epr-icn-" + n, (e = {}, e[h.active] = a, e)),
    onClick: o,
    "aria-label": Jn(r),
    "aria-selected": a,
    role: "tab",
...
}, St = /* @__PURE__ */ J.create(/* @__PURE__ */ O({
  catBtn: {
    ".": "epr-cat-btn",
...
}, /* @__PURE__ */ zf("catBtn", kt), {
  ".epr-dark-theme": /* @__PURE__ */ O({}, Cn),
  ".epr-auto-theme": /* @__PURE__ */ O({}, Cn)
}));
function Dt() {
  var f = R(null), e = f[0], a = f[1], n = pt();
  ht(a);
  var i = _e(), r = qn(), o = Da(), u = vt();
  return g("div", {
    className: v(Tt.nav),
    role: "tablist",
...
function xt() {
  var f = g0();
  return g(Ie, {
    className: v(yn.btnClearSearch, Jf.visibleOnSearchOnly),
    onClick: f,
    "aria-label": "Clear",
    title: "Clear"
  }, g("div", {
    className: v(yn.icnClearnSearch)
  }));
}
var zt = {
  ":hover": {
...
}, yn = /* @__PURE__ */ J.create(/* @__PURE__ */ O({
  btnClearSearch: {
...
}, /* @__PURE__ */ zf("icnClearnSearch", {
  backgroundPositionY: "-40px"
}), /* @__PURE__ */ zf("btnClearSearch", zt))), sa = /* @__PURE__ */ q(h.emojiPicker) + " " + /* @__PURE__ */ q(h.emojiList), U0 = /* @__PURE__ */ ["button", q(h.emoji)].join(""), Et = /* @__PURE__ */ q(h.category);
function At(f) {
  var e = f.value;
  if (!e)
    return null;
...
function Pt(f) {
  return [U0, '[data-full-name*="', La(f), '"]'].join("");
}
...
function Qt() {
  return g("div", {
    className: v(Yt.icnSearch)
  });
}
var Yt = /* @__PURE__ */ J.create(/* @__PURE__ */ O({
  icnSearch: {
    ".": "epr-icn-search",
    content: "",
    position: "absolute",
...
}, /* @__PURE__ */ zf("icnSearch", {
  backgroundPositionY: "-20px"
})));
function Jt() {
  var f = e0(), e = xa();
  return f ? null : g(Y0, {
    className: v(Ye.overlay)
  }, g(Ot, null), e ? g(J0, null) : null);
}
function Ot() {
  var f = R(0), e = f[0], a = f[1], n = Bf(), i = Af(), r = Ii(), o = ki(), u = tr(), d = u.statusSearchResults, s = u.searchTerm, c = u.onChange, w = i == null ? void 0 : i.current, L = w == null ? void 0 : w.value;
  return g(ea, {
    className: v(Ye.searchContainer)
  }, g(At, {
    value: L
  }), g("input", {
    ...
    onChange: function(I) {
      a(e + 1), setTimeout(function() {
        var T, Q;
        c((T = I == null || (Q = I.target) == null ? void 0 : Q.value) != null ? T : L);
      });
    },
    ref: i
  }), s ? g("div", {
    role: "status",
    className: v("epr-status-search-results", Ye.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
  }, d) : null, g(Qt, null), g(xt, null));
}
var Ye = /* @__PURE__ */ J.create(/* @__PURE__ */ O({
  overlay: {
    padding: "var(--epr-header-padding)",
...
function Ut() {
  return g(ea, {
    className: v("epr-header", Jf.hiddenOnReactions)
  }, g(Jt, null), g(Dt, null));
}
function Bt(f) {
  return g(Bi, null, g(Q1, null), g(Li, Object.assign({}, f), g(Gt, null)));
}
function Gt() {
  var f = ie(), e = f[0], a = Xn(), n = R(!e), i = n[0], r = n[1], o = Di();
  return B(function() {
    e && !a || i || r(!0);
  }, [i, a, e]), o ? g(Ir, null, g($r, null), g(Zt, {
    renderAll: i
  })) : null;
}
function Zt(f) {
  var e = f.renderAll;
  return e ? g(ma, null, g(Ut, null), g(ct, null), g(mt, null)) : null;
}
var Ht = /* @__PURE__ */ vn(Bt, Rn), Wt = /* @__PURE__ */ (function(f) {
  A1(e, f);
  function e(n) {
    var i;
...
function Ft(f) {
  ...
  return g(Wt, null, g(Vn.Provider, {
    value: e
  }, g(Ht, Object.assign({}, f))));
}
const _t = ({
  newMsg: f,
  setNewMsg: e,
  ...
  isLoading: i,
  showEmojiPicker: r,
  setShowEmojiPicker: o,
  handleKeyPress: u,
  handleFileChange: d,
  selectedFile: s,
  onStartNewChat: c
}) => {
  const w = V(null), L = V(null);
  return B(() => {
    if (!r) return;
    const j = (T) => {
      L.current && !L.current.contains(T.target) && o(!1);
    }, I = (T) => {
      T.key === "Escape" && o(!1);
    };
    return document.addEventListener("mousedown", j), document.addEventListener("keydown", I), () => {
      document.removeEventListener("mousedown", j), document.removeEventListener("keydown", I);
    };
  }, [r, o]), B(() => {
    var j;
    (j = w.current) == null || j.focus();
  }, [f]), n ? /* @__PURE__ */ l.jsxs("div", { className: "chat-input-area disabled", children: [
    /* @__PURE__ */ l.jsxs("div", { className: "chat-closed-notice", children: [
      /* @__PURE__ */ l.jsxs(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
          ...
          strokeLinejoin: "round",
          children: [
            /* @__PURE__ */ l.jsx("rect", { x: "3", y: "11", width: "18", height: "10", rx: "2", ry: "2" }),
        ...
        children: [
          /* @__PURE__ */ l.jsx(
            "svg",
            {
              ...
              strokeLinecap: "round",
              strokeLinejoin: "round",
              children: /* @__PURE__ */ l.jsx("path", { d: "M12 2v20M2 12h20" })
            }
          ),
  ...
  ] }) : /* @__PURE__ */ l.jsxs("div", { className: "chat-input-area", children: [
    /* @__PURE__ */ l.jsx(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ l.jsxs(
          "svg",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ l.jsx("path", { d: "M8 14s1.5 2 4 2 4-2 4-2" }),
              /* @__PURE__ */ l.jsx("line", { x1: "9", y1: "9", x2: "9.01", y2: "9" }),
              /* @__PURE__ */ l.jsx("line", { x1: "15", y1: "9", x2: "15.01", y2: "9" })
            ]
          }
        )
      }
    ...
    /* @__PURE__ */ l.jsx(
      ...
      {
        htmlFor: "file-upload",
        className: `file-upload-btn ${i ? "disabled" : ""}`,
        ...
        children: /* @__PURE__ */ l.jsx(
          "svg",
          {
            ...
            strokeLinecap: "round",
            strokeLinejoin: "round",
            children: /* @__PURE__ */ l.jsx("path", { d: "M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48" })
          }
        )
      }
    ),
    ...
    /* @__PURE__ */ l.jsx(
      "input",
      {
        ...
        onKeyDown: u,
        placeholder: i ? "Enviando..." : "Escribe tu mensaje...",
      ...
      "button",
      {
        ...
        children: i ? /* @__PURE__ */ l.jsx(
          "svg",
          {
            ...
            strokeLinejoin: "round",
            className: "loading",
            children: /* @__PURE__ */ l.jsx("path", { d: "M21 12a9 9 0 11-6.219-8.56" })
          }
        ) : /* @__PURE__ */ l.jsxs(
          "svg",
          {
            ...
            strokeLinejoin: "round",
            children: [
              /* @__PURE__ */ l.jsx("line", { x1: "22", y1: "2", x2: "11", y2: "13" }),
              /* @__PURE__ */ l.jsx("polygon", { points: "22 2 15 22 11 13 2 9 22 2" })
            ]
          }
        )
      }
    ),
    r && /* @__PURE__ */ l.jsx("div", { className: "emoji-picker-wrapper", ref: L, role: "dialog", "aria-label": "Selector de emojis", children: /* @__PURE__ */ l.jsx("div", { className: "emoji-picker-container", children: /* @__PURE__ */ l.jsx(
      Ft,
      {
        onEmojiClick: (j) => {
          e(f + j.emoji), o(!1);
  ...
  const [r, o] = R(null), [u, d] = R([]), [s, c] = R(""), [w, L] = R(!1), [j, I] = R(!1), [T, Q] = R(!1), [Y, C] = R(!1), [K, ff] = R(null), [ef, af] = R(null), [Rf, Zf] = R(null), [bf, Hf] = R(!1), [aa, Df] = R(!1), [Nf, jf] = R(0), U = {
    ...
    isClosed: `chat_${f}_${a}_closed`
  }, Ne = () => typeof i == "number" ? i : a === "erp" ? 2 : a === "avaluos" ? 3 : 1;
  B(() => {
    const E = localStorage.getItem(U.chatId), N = localStorage.getItem(U.messages), D = localStorage.getItem(U.hasStarted), x = localStorage.getItem(U.isClosed);
    if (console.log("🔄 Cargando estado del chat desde localStorage:", {
      savedChatId: E,
      savedHasStarted: D,
      savedIsClosed: x,
      hasMessages: !!N
    }), E && D === "true" && x !== "true") {
      if (console.log("✅ Restaurando chat activo existente"), o(E), I(!0), Hf(!1), N)
        try {
          const k = JSON.parse(N);
          d(k), console.log("✅ Mensajes restaurados:", k.length);
        } catch (k) {
          console.error("❌ Error parsing saved messages:", k), Wf();
        }
    } else if (x === "true") {
      if (console.log("🔒 Chat fue cerrado por soporte - manteniendo estado cerrado"), Hf(!0), N)
        try {
          const k = JSON.parse(N);
          d(k);
        } catch (k) {
          console.error("❌ Error parsing saved messages:", k);
        }
    } else
      console.log("📝 No hay chat previo o fue invalidado"), Wf();
  }, []);
  const Wf = () => {
    console.log("🧹 Limpiando localStorage del chat"), localStorage.removeItem(U.chatId), localStorage.removeItem(U.messages), localStorage.removeItem(U.hasStarted), localStorage.removeItem(U.isClosed);
  }, ke = () => {
    if (console.log("🆕 Iniciando nuevo chat - estado actual:", {
      isChatClosed: bf,
      hasStarted: j,
      chatId: r
    }), !bf) {
    ...
    console.log("✅ Limpiando estado para nuevo chat"), Wf(), o(null), d([]), I(!1), L(!1), Hf(!1), jf(0);
  };
  B(() => () => {
    j1().catch((E) => console.error("Error during cleanup:", E));
  }, []), B(() => {
    if (!j || bf || !r || w)
      return;
    console.log("🔌 Conectando al chat:", { chatId: r, hasStarted: j, isChatClosed: bf, hasConnected: w }), (async () => {
      try {
        await b1(
          r,
          // Callback para recibir mensajes
          (N, D, x, k, F = []) => {
            console.log("📩 Mensaje recibido por SignalR:", { sessionId: N, sender: D, content: x, sentAt: k, attachments: F });
            const of = D;
            if (!x && (!F || F.length === 0)) {
              console.log("⚠️ Mensaje vacío ignorado");
              return;
            }
            const X = (F == null ? void 0 : F.map((A) => {
              var nf, $;
              console.log("📎 Procesando attachment RAW:", A), console.log("📎 Propiedades del attachment:", Object.keys(A));
              const hf = A.FileName || A.fileName || "archivo", pf = A.FileType || A.fileType || "application/octet-stream";
              let _ = A.FilePath || A.filePath || "";
              console.log("📎 fileName extraído:", hf), console.log("📎 fileType extraído:", pf), console.log("📎 filePath extraído:", _), _ && !_.startsWith("http") && (_ = `${(typeof window < "u" && window.CHAT_API_BASE || (($ = (nf = import.meta) == null ? void 0 : nf.env) == null ? void 0 : $.VITE_CHAT_API_BASE) || "https://borrador-n453.onrender.com/api").replace(/\/api$/, "")}/${_}`);
              const uf = {
                fileName: hf,
                fileType: pf,
                filePath: _,
              ...
              return console.log("📎 Attachment procesado FINAL:", uf), console.log("📎 ¿Es imagen?", uf.fileType.startsWith("image/")), uf;
            })) || [], mf = {
              id: `msg-${Date.now()}-${Math.random()}`,
              sender: of,
              content: X.length > 0 && x === "[Archivo]" ? "" : x,
              sentAt: k,
              attachments: X.length > 0 ? X : void 0
            };
            console.log("✅ Agregando mensaje:", mf), d((A) => {
              if (x === "[Archivo]" && X.length > 0) {
                ...
                const nf = [...uf, mf];
                return localStorage.setItem(U.messages, JSON.stringify(nf)), nf;
              }
              if (x === "[Archivo]" && X.length === 0) {
              ...
              if (A.some((_) => {
                const uf = _.content === mf.content, nf = _.sentAt === k, $ = _.sender === of;
                return uf && nf && $;
              }))
                return console.log("⚠️ Mensaje duplicado detectado, ignorando"), A;
              console.log("✅ Agregando mensaje nuevo al state");
              const pf = [...A, mf];
              return localStorage.setItem(U.messages, JSON.stringify(pf)), pf;
            }), !T && D !== "client" && jf((A) => A + 1);
          },
          // Callback para cuando el chat es cerrado por soporte
          (N, D, x) => {
            console.log("🔒 Chat cerrado por soporte:", { sessionId: N, message: D, timestamp: x });
            const F = {
              id: `system-${Date.now()}`,
              sender: "system",
              content: "La sesión de soporte técnico ha sido finalizada por nuestro equipo. Si requiere asistencia adicional, puede iniciar una nueva conversación.",
              sentAt: x
            };
            d((of) => {
              const X = [...of, F];
              return localStorage.setItem(U.messages, JSON.stringify(X)), X;
            }), Hf(!0), L(!1), localStorage.setItem(U.isClosed, "true"), console.log("✅ Estado del chat actualizado a cerrado");
          }
        ), L(!0);
      } catch (N) {
        console.error("Error connecting to chat:", N);
      }
    })();
  }, [j, w, r, bf, T]);
  const te = async () => {
    ...
    if (!j) {
      const N = n || Pe();
      console.log("[chat] Intentando iniciar chat en", N, "con systemCode=", a);
      const D = await g1(f, a, e, N);
      if (!D || !D.id) {
...
` + A), Df(!1);
      ...
      const x = n || Pe(), k = x.replace(/\/api$/, ""), X = (await (await fetch(`${x}/chat/${E}/messages`)).json()).map((mf) => {
        var A;
        return {
          ...mf,
          attachments: (A = mf.attachments) == null ? void 0 : A.map((hf) => {
            var pf;
            return {
              ...hf,
              filePath: (pf = hf.filePath) != null && pf.startsWith("http") ? hf.filePath : `${k}/${hf.filePath}`
            };
          })
        };
      });
    ...
    try {
      ...
      const D = await fetch(`${N}/Chat/send`, {
        method: "POST",
        headers: {
...
` + k), Df(!1);
      ...
      if (ef) {
        ...
        k.append("file", ef), k.append("messageId", x.id);
        const F = await fetch(`${N}/Attachment/upload`, {
          method: "POST",
          body: k
        });
        if (F.ok)
          ...
          const of = await F.text();
          console.error("[chat] error subiendo archivo", of);
        }
      }
      c(""), af(null), ff(null);
    } catch (N) {
    ...
    if (x < 24 && N.toDateString() === D.toDateString())
      return N.toLocaleTimeString("es-ES", {
        hour: "2-digit",
        minute: "2-digit"
      });
    if (x < 48) {
      const k = new Date(D);
      if (k.setDate(k.getDate() - 1), N.toDateString() === k.toDateString())
        return `Ayer ${N.toLocaleTimeString("es-ES", {
          hour: "2-digit",
          minute: "2-digit"
        })}`;
    }
    if (x < 168) {
      const k = N.toLocaleDateString("es-ES", { weekday: "short" }), F = N.toLocaleTimeString("es-ES", {
        hour: "2-digit",
        minute: "2-digit"
      });
      return `${k} ${F}`;
    }
    return N.toLocaleDateString("es-ES", {
      day: "2-digit",
      month: "2-digit",
      year: "2-digit",
      hour: "2-digit",
    ...
    E.key === "Enter" && !bf && (E.preventDefault(), te());
  }, Te = (E) => {
    var D;
    const N = (D = E.target.files) == null ? void 0 : D[0];
    if (N)
      if (af(N), N.type.startsWith("image/")) {
        const x = new FileReader();
        x.onloadend = () => ff(x.result), x.readAsDataURL(N);
      } else
        ff(null);
  };
  return /* @__PURE__ */ l.jsxs("div", { className: "gtc-chat-root", children: [
    /* @__PURE__ */ l.jsx(
      m1,
      {
        isOpen: T,
    ...
    T && /* @__PURE__ */ l.jsxs("div", { className: "chat-widget-window", children: [
      /* @__PURE__ */ l.jsx(
        C1,
        {
          onClose: () => Q(!1),
    ...
    Rf && /* @__PURE__ */ l.jsx(
      "div",
      {
        ...
        onClick: () => Zf(null),
        onKeyDown: (E) => {
          E.key === "Escape" && Zf(null);
        },
        tabIndex: 0,
        children: /* @__PURE__ */ l.jsxs("div", { className: "image-modal-content", onClick: (E) => E.stopPropagation(), children: [
          /* @__PURE__ */ l.jsx("div", { className: "image-modal-controls", children: /* @__PURE__ */ l.jsx(
            "button",
            {
              className: "image-modal-close",
              onClick: () => Zf(null),
              "aria-label": "Cerrar imagen",
              children: /* @__PURE__ */ l.jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ l.jsx("path", { d: "M18 6L6 18M6 6L18 18", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }) })
            }
          ) }),
          /* @__PURE__ */ l.jsx(
            "img",
          ...
          /* @__PURE__ */ l.jsx("div", { className: "image-modal-info", children: "Haz clic fuera de la imagen o presiona ESC para cerrar" })
        ] })
      }
    )
  ] });
...
function Kt() {
  ...
  if (process.env.NODE_ENV === "production")
    Kf.createRoot = f.createRoot, Kf.hydrateRoot = f.hydrateRoot;
  else {
    var e = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    Kf.createRoot = function(a, n) {
    ...
    }, Kf.hydrateRoot = function(a, n, i) {
      e.usingClientEntryPoint = !0;
      try {
        return f.hydrateRoot(a, n, i);
      } finally {
        e.usingClientEntryPoint = !1;
      }
    };
...
async function fo(f) {
  const { clientId: e, systemCode: a, clientName: n = "", containerId: i = "client-chat-widget" } = f;
